...
class m_pengerjaan extends CI_Model {
    ...
    $this->datatables->select('a.id as id,a.nota,c.nama as nama_frame,c.kode_frame,c.state,d.jenis_lensa,a.status_pengerjaan, a.tanggal_pengerjaan as tanggal_pengerjaan, a.tanggal_selesai_pengerjaan as tanggal_selesai_pengerjaan');
    ...
    $this->datatables->add_column('view', '<button type="button" onclick="edit(`$1`)" type="button" class="btn btn-outline-secondary btn-sm"><i class="fa fa-trash"></i> Edit status</button>', 'id,a.nota,a.frame,a.lensa,c.nama as nama_frame,c.kode_frame,c.state,d.jenis_lensa,a.status_pengerjaan,b.nama as nama_pengguna,a.tanggal_pengerjaan as tanggal_pengerjaan, a.tanggal_selesai_pengerjaan as tanggal_selesai_pengerjaan');
